...
const Lnb = ({ active }: Lnb) => {
    return (
        <>
            <div
                className={`hidden sticky top-0 h-[100vh] lg:flex shrink-0 flex-col bg-[var(--moneed-gray-3)] pt-[3.2rem] max-w-[20.8rem] ${active ? "pl-[3.2rem] pr-[2.4rem]" : "px-[1.6rem]"
                }`}
            >
                ...
                <div className="shrink-0 pb-[2rem]">
                    ...
                    <div className="flex items-center gap-x-[.8rem] flex-wrap mt-[.8rem]">
                        <Link to="" className="text-[var(--moneed-gray-7)] text-[1rem] font-semibold leading-[135%]">
                            이용약관
                        </Link>
                        <i className="w-[.1rem] h-[1rem] bg-[var(--moneed-gray-7)]"></i>
                        <Link to="" className="text-[var(--moneed-gray-7)] text-[1rem] font-semibold leading-[135%]">
                            개인정보처리방침
                        </Link>
                        <i className="w-[.1rem] h-[1rem] bg-[var(--moneed-gray-7)]"></i>
