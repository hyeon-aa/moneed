...
const OnBoarding = () => {
  const handleKakaoLogin = () => {
    ...
    const redirectUri = import.meta.env.VITE_KAKAO_DEV_REDIRECT_URL;
      ...
      <div className="relative h-[100vh] overflow-hidden px-[1.8rem] pt-8 bg-[url('/line-bg.png')] bg-[length:8rem_8rem] lg:bg-[url('/line-bg-pc.png')]">
        <div className="flex">
          <div className="w-[2.8rem] h-[2.8rem] bg-[var(--moneed-black)] rounded-full flex items-center justify-center">
            <img
              className="w-[1.4rem] h-[1.2rem]"
              src="/icon/icon-logo.svg"
              alt=""
            />
          </div>
          <span className="font-[600] leading-[140%] text-[1.8rem] ml-[.8rem]">
            moneed
          </span>
        </div>
        ...
        <div className="absolute bottom-0 right-0 h-full left-0 lg:hidden">
          ...
          <img
            ...
            alt=""
            className="absolute right-[-4rem] bottom-[35rem] w-[16.6rem]"
          />
          <img
